...
describe("rangeSum1", () => {
    it("should return 6 for given input 0, 3", () => {
        assert.deepStrictEqual(rangeSum1(0, 3), 6);
    });

    it("should return 10 for given input 1, 4", () => {
        assert.deepStrictEqual(rangeSum1(1, 4), 10);
    });

    it("should return 203 for given input 101, 102", () => {
        assert.deepStrictEqual(rangeSum1(101, 102), 203);
    });
});
